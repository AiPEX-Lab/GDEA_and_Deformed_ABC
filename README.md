...
## Abstract
We propose iterative message passing using a global-weight matrix assembled via the direct stiffness method. This method is implemented through a deep equilibrium model with Anderson acceleration to ensure fast convergence and low memory cost.
...
Further details on the FEM formulation and data preprocessing are provided in the Supplementary Material, and Code snippets for data preprocessing are available in this repository.
