...
The resulting dataset is then preprocessed via filtering and scaling. Further details on the FEM formulation and data preprocessing are provided in the Supplementary Information, and Code snippets for data preprocessing are available in this repository.
